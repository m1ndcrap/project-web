...
/// <summary>
/// Controls the spawning and animation of bubble particle effects in sewer area in "Mission" scene.
/// </summary>
...
public class BubbleSpawner : MonoBehaviour
{
    ...
    /// <summary>
    /// Executes the alarm routine for the specified bubble particle, introducing a randomized delay before resetting
    /// its state.
    /// </summary>
    /// <param name="b">The bubble particle to process. The routine sets its waiting state, applies a randomized delay, and resets relevant properties after the delay.</param>
    /// <returns>An enumerator that performs the alarm routine, suitable for use with Unity coroutines.</returns>
    ...
    /// <summary>
    /// Assigns randomized position, frame index, and scale values to the specified bubble particle.
    /// </summary>
    /// <param name="b">The bubble particle to randomize. The method updates its position, frame index, and scale properties.</param>
    ...
    /// <summary>
    /// Represents a single bubble particle with rendering and state information used for visual effects.
    /// </summary>
