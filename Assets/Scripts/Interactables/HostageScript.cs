...
/// <summary>
/// Controls the behavior of a hostage character, including animations, audio, and interaction with the player.
/// </summary>
...
public class HostageScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else
        {
            ...
            {
                // Only call out about half the time so it does not get repetitive
                if (UnityEngine.Random.Range(0, 2) == 0)
                {
                    audioSrc.clip = sndHelp;
                    audioSrc.Play();
                }
            }
    ...
    /// <summary>
    /// Handles the logic for rescuing the hostage, including stopping audio, setting alarms, and updating the phase.
    /// </summary>
